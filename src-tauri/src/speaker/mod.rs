...
#[cfg(target_os = "macos")]
use macos::{
    MicInput as PlatformMicInput, MicStream as PlatformMicStream,
    SpeakerInput as PlatformSpeakerInput, SpeakerStream as PlatformSpeakerStream,
};
...
// Pluely microphone input and stream
pub struct MicInput {
    #[cfg(any(target_os = "macos", target_os = "windows", target_os = "linux"))]
    inner: PlatformMicInput,
}

impl MicInput {
    #[cfg(any(target_os = "macos", target_os = "windows", target_os = "linux"))]
    pub fn new_with_device(device_id: Option<String>) -> Result<Self> {
        let inner = PlatformMicInput::new(device_id)?;
        Ok(Self { inner })
    }
    ...
    pub fn new_with_device(_device_id: Option<String>) -> Result<Self> {
        Err(anyhow::anyhow!(
            "MicInput::new_with_device is not supported on this platform"
        ))
    }
    ...
    #[cfg(not(any(target_os = "macos", target_os = "windows", target_os = "linux")))]
    pub fn stream(self) -> MicStream {
        unimplemented!("MicInput::stream is not supported on this platform")
    }
}

pub struct MicStream {
    #[cfg(any(target_os = "macos", target_os = "windows", target_os = "linux"))]
    inner: PlatformMicStream,
}
